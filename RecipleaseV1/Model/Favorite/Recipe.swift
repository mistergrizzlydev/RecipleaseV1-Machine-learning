...
class Recipe: NSManagedObject {
	...
	static var all: [Recipe] {
		let request: NSFetchRequest<Recipe> = Recipe.fetchRequest()// création de la request Favorite. On précise entre les chevrons le type de résultat que va retourner notre requête. Comme pour un tableau, le type est incomplet si on ne fournit pas cette information.
